	...
	return (
		<FormProvider {...form}>
			...
			>
				...
				<button
					type="submit"
					className="mt-6 w-full rounded-md bg-primary-foreground py-2 font-bold text-primary hover:shadow-[0_2px_4px_0_rgb(0,0,0,0.9)] active:translate-y-1 active:shadow-none dark:hover:shadow-[0_2px_4px_0_rgb(255,255,255,0.9)] dark:hover:active:shadow-none"
				>
					Create Account
				</button>
			</form>
